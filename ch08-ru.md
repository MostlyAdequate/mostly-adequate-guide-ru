...
Не секрет, что колбэки _(обратные вызовы, callbacks)_ – это винтовая лестница в ад. Видимо, этот способ передачи управления разрабатывал Мауриц Корнелис Эшер. Работа в таком стиле является не столько продуктивным занятием, сколько испытанием: как долго мы сможем продолжать вкладывать колбэки в колбэки, прежде чем потеряем возможность понимать и изменять этот код? К счастью, существует намного более пригодный инструмент композиции асинхронного кода.
