...
Это может стать шоком, но операторы `throw/catch` не очень то и чистые. Когда брошено исключение, вместо того, чтобы вернуть значение, мы бьём тревогу! Функция атакует, извергая тысячи нулей и единиц, как щиты и копья в электриеской битве против вторгающегося ввода данных. С нашим новым другом `Either`, мы можем сделать лучше, чем объявлять войну вводу, мы можем ответить вежливым сообщением. Давайте взглянем:
