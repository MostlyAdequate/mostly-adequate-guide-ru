...
// Бонус 1:
// ============
// Отрефакторите availablePrices с помощью композиции.
...
// Бонус 2:
// ============
// Отрефакторите в стиле отсутствия ссылок. Подсказка: вы можете использовать _.flip()
